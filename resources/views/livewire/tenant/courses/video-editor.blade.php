            ...
            <div x-data="{ 
                ...
                <label for="video" class="relative block p-4 bg-gray-100 rounded-lg cursor-pointer">
                    ...
                    <div x-show="!imgPreview && done" class="mb-3">
                        <div class="w-64 h-32 mx-auto bg-gray-300 rounded-md">
                            <div role="status">
                ...
                <section x-show="uploading" x-cloak class="mt-2">
                    <div class="flex justify-between mb-1">
                        <span x-show="progress < 100" class="text-xs font-medium text-emerald-700 dark:text-white">Uploading</span>
                        <span x-show="progress == 100" class="text-xs font-medium text-emerald-700 dark:text-white">Done Upload</span>
