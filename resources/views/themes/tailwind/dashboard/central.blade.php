...
<div class="px-8 pt-6 pb-32 bg-gray-100">
	...
	<div class="grid grid-cols-4 gap-6">
		<a href="{{ url('organization') }}" class="block p-4 bg-white border rounded-md shadow-md hover:bg-emerald-50">
			<div>
		...
		<a href="{{ url('billing') }}" class="block p-4 bg-white border rounded-md shadow-md hover:bg-emerald-50">
			<div>
