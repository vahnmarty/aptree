<header x-data="{ mobileMenuOpen: false }" class="relative z-30 bg-white dark:bg-gray-900">
    <div class="px-8 mx-auto xl:px-5 max-w-7xl">
        <div class="flex items-center justify-between h-24 border-b-2 border-gray-100 dark:border-gray-600 md:justify-start md:space-x-6">
            <div class="inline-flex">
                <a href="{{ route('wave.home') }}" class="flex items-center justify-center space-x-3 transition-all duration-1000 ease-out transform text-wave-500">
                    <img src="{{ global_asset('img/logo.png') }}" alt="" class="w-auto h-10 lg:h-12">
                </a>
            </div>
