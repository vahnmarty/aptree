        ...
        <nav class="flex flex-col flex-1 mt-5 overflow-y-auto divide-y divide-gray-300" aria-label="Sidebar">
          <div  class="flex-1 space-y-1 md:px-2">
            ...
            <a href="{{ route('courses.index') }}"
                class="{{ request()->routeIs('courses*') ? 'border-l-4 border-orange-400 bg-gray-100 text-black' : 'text-gray-500 hover:bg-gray-100' }} group flex items-center px-2 py-2 text-sm leading-6 font-medium">
            ...
            <a href="{{ route('template.library') }}"
                class="{{ request()->is('template-library') ? 'border-l-4 border-orange-400 bg-gray-100 text-black' : 'text-gray-500 hover:bg-gray-100' }} group flex items-center px-2 py-2 text-sm leading-6 font-medium">
                <svg class="flex-shrink-0 w-6 h-6 ml-1 mr-4 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <a href="{{ route('teams.index') }}"
                class="{{ request()->is('teams*') ? 'border-l-4 border-orange-400 bg-gray-100 text-black' : 'text-gray-500 hover:bg-gray-100' }} group flex items-center px-2 py-2 text-sm leading-6 font-medium">
                <svg class="flex-shrink-0 w-6 h-6 ml-1 mr-4 text-gray-500"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <a href="{{ route('profile.index') }}"
                class="{{ request()->is('profile*') ? 'border-l-4 border-orange-400 bg-gray-100 text-black' : 'text-gray-500 hover:bg-gray-100' }} group flex items-center px-2 py-2 text-sm leading-6 font-medium">
                <svg class="flex-shrink-0 w-6 h-6 ml-1 mr-4 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
